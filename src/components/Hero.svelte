...
<section class={styles.laundry} id='home'>
    <div class={styles.laundryblack}>
        ...
        <div class='mx-auto max-w-7xl px-4 sm:px-6'>
          <div class='lg:flex lg:justify-center lg:items-center lg:flex-col mx-auto lg:gap-16 justify-center'>
            <div class='relative z-10 px-4 mb-8 sm:px-6 sm:text-center sm:mb-16 lg:mb-0 lg:px-0 lg:flex col-span-6'>
              <div class='lg:py-24 flex items-center justify-center flex-col'>
                <p class='mt-4 mb-4 grid grid-cols-1 animate-fade-up animate-duration-[1200ms] animate-delay-500 animate-ease-out justify-items-center text-2xl pb-3 lg:text-6xl h-full font-[PoppinsBold] text-white tracking-tight font-extrabold primary-title sm:mt-5 text-center'>
                  Limpieza profesional.
                  <span class='pt-3 animate-fade-up animate-duration-[1200ms] animate-delay-700 animate-ease-out'>Cuidado personalizado.</span>
